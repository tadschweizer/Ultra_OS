            ...
            return (
              ...
              >
                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-ink shadow-[0_4px_14px_rgba(19,24,22,0.22)]">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 stroke-paper">
