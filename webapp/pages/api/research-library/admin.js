...
function normalizePayload(body = {}) {
  return {
    ...
    running_score:    parseOptionalInt(body.running_score,    0),
    cycling_score:    parseOptionalInt(body.cycling_score,    0),
    swimming_score:   parseOptionalInt(body.swimming_score,   0),
    rowing_score:     parseOptionalInt(body.rowing_score,     0),
    skating_score:    parseOptionalInt(body.skating_score,    0),
    ski_score:        parseOptionalInt(body.ski_score,        0),
    team_sport_score: parseOptionalInt(body.team_sport_score, 0),
